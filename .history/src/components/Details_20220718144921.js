                ...
                <div className="modalContainer">
                    <div className="modalBody">
                       <div className="container">
                            <div className="card">
                                <img className="card-img-top" src={this.props.data.selectedDetails.album.cover} alt="Card image cap"></img>
  
                                    <div className="card-body">
                                        <div className="modalHeader">
                                            <span className="btn-close" disabled aria-label="Close" onClick={() => this.selectDetails(null)}> x </span>
                                        </div>
