...
export class TrackList extends Component {
    ...
    sortTracks(direction) {
        ...
        console.log("sortiram", direction);
    }
    ...
    render() {
        ...
        return (
            ...
            <div>
                ...
                <select onChange={e => this.sortTracks(e.target.value)} class="form-select" aria-label="Default select example">
    ...
    { this.state.errorMsg ? <div> {errorMsg} </div> : null}
        </div>
