    ...
    render() {
        ...
        return (
            ...
            <div>
                ...
                {
                    this.state.tracks && this.state.tracks.data.length && <select onChange={e => this.setDirection(e.target.value)} className="form-select" aria-label="Default select example">
