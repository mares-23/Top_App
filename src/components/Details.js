                                ...
                                <img className="card-img-top" src={this.props.data.selectedDetails.album.cover_medium} alt="Card image cap"></img>
                                    ...
                                    <div className="card-body">
                                        <div className="modalHeader">
                                            ...
                                            <div className="row"><p className="card-text">Song: {'  ' + this.props.data.selectedDetails.title_short}</p></div>
                                            <div className="row"><p className="card-text">Artist:{'  ' + this.props.data.selectedDetails.artist.name}</p></div>
                                            <div className="row"> <p className="card-text">Duration:{'  ' + this.state.formattedDuration}</p></div>
                                    </div>
                            </div>
                        </div>
                    </div>
